...
ENCODER= 'timm-efficientnet-b1' # densenet121'#'vgg13' #timm-efficientnet-b0'  #"mobilenet_v2"  
...
if winNolinux:
    ...
    save_path = '../parameter/seg_pytorch/%s/best_model'%ENCODER
    save_last_path = '../parameter/seg_pytorch/%s/best_model_last.pth'%ENCODER
    #pre_path = '../parameter/seg_pytorch/%s/best_model.pth'%ENCODER
    #save_path ='D:/pengt/segmetation/4channels/Unet4/parameter/%s/best_model.pth'%ENCODER
    init_pre_path='../parameter/seg_pytorch/%s/best_model_last.pth'%ENCODER
